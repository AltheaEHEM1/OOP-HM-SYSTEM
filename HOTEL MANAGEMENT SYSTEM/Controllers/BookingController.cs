...
namespace HOTEL_MANAGEMENT_SYSTEM.Controllers
{
    public class BookingController
    {
        ...
        public void AddBooking(int roomId, int guestId, string checkInDate, string checkoutDate, string bookingDate, int numberOfGuest, string bookingStatus)
        {
        ...
        // Method to update booking record
        public void UpdateBookingRecord(int bookingId, int? roomId = null, int? guestId = null, string checkInDate = null, string checkoutDate = null, string bookingDate = null, int? numberOfGuest = null, string bookingStatus = null)
        {
            using (var context = new DataContext())
            {
                try
