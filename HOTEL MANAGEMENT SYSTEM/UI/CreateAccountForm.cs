        ...
        private void CreateAcc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrWhiteSpace(FullName) || string.IsNullOrWhiteSpace(EmailAdd) || string.IsNullOrWhiteSpace(Birthdate) ||
                    string.IsNullOrWhiteSpace(PhoneNum) || string.IsNullOrWhiteSpace(Password) || string.IsNullOrWhiteSpace(ConfirmPass))
                {
                ...
                if (!controller.CreateAccount(FullName, EmailAdd, Birthdate, PhoneNum, Password))
                {
